...
export default function MetronomePage() {
  ...
  const playClick = () => {
    ...
    osc.type = "square";
    osc.frequency.value = 1000; // click tone
  ...
  useEffect(() => {
    ...
    const intervalMs = Math.max(30, Math.round((60_000) / bpm));
...
/**
 * Simple beat visualizer that briefly scales and flashes on mount.
 */
  ...
  return (
    <div className="flex items-center justify-center pt-2">
      <div
        ...
        style={{
          // quick CSS animation via inline keyframes
